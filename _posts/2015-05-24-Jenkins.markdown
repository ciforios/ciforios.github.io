...
SSH Keyfile and password which you generated also in this section. Further changes can be made regarding the values which will be given from Jenkins to Gerrit once triggered.
